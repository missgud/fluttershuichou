...
class NavigatorUtil {
  ...
  static Future jump(BuildContext context, String title) {
    return Application.router.navigateTo(
        context, title, transition: TransitionType.inFromRight);
  }
  ...
  static Future jumpLeft(BuildContext context, String title) {
    return Application.router.navigateTo(
        context, title, transition: TransitionType.inFromLeft);
  }
...
//
//  /// 自定义 转场动画
//  static Future gotransitionCustomDemoPage(BuildContext context,
//      String title) {
...
//
  ...
  static Future goUseCupertino(BuildContext context,
      String title) {
    return Application.router.navigateTo(
        context, title, transition: TransitionType.cupertino);
  }
//
